...
namespace BookingService.ViewModels
{
    public class AddRoomViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<HotelRoom> _templates = new ObservableCollection<HotelRoom>();
        private HotelRoom _selectedTemplate;
        ...
        public ObservableCollection<HotelRoom> Templates { get => _templates; set { _templates = value; OnPropertyChanged(); } }
        public HotelRoom SelectedTemplate { get => _selectedTemplate; set { _selectedTemplate = value; OnPropertyChanged(); } }
        ...
        private void LoadTemplate(object parameter)
        {
            ...
            Rating = SelectedTemplate.Rating.ToString();
            Price = SelectedTemplate.Price.ToString();
            NumberOfBeds = SelectedTemplate.NumberOfBeds.ToString();
            Amenities = SelectedTemplate.Amenities;
            Stars = SelectedTemplate.Stars.ToString();
            HasBalcony = SelectedTemplate.HasBalcony;
            IsNonSmoking = SelectedTemplate.IsNonSmoking;

            UpdateImagePreview();
            ClearValidationError();
        }

        private bool CanLoadTemplate(object parameter)
        {
